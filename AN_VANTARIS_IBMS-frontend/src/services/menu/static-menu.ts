...
const domains: MenuDomainInput[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'asset-registry', label: 'Asset Registry', path: '/one/assets/context', status: 'implemented', l3: ['Asset Risk Signal', 'Asset Relationship Context', 'Asset Action Workflow', 'Asset Governance Audit', 'Asset Evidence Pack', 'Asset Readiness Quality'], mappedExistingModule: 'AssetContext' },
      ...
      { id: 'points-tags', label: 'Point & Tag Governance', path: '/assets/topology', status: 'mapped', l3: ['Point Quality Signal', 'Tag Mapping Context', 'Point Action Workflow', 'Point Governance Audit', 'Point Evidence Pack', 'Tag Readiness Quality'], mappedExistingModule: 'AssetsTopology' },
  ...
  },
  {
    ...
    icon: 'W',
    children: [
      { id: 'work-orders', label: 'Work Order Control', path: '/one/umms/workspace', status: 'implemented', l3: ['Open Work Orders', 'Assigned Work Orders', 'Emergency Work Orders', 'Fault-linked Work Orders', 'Preventive Work Orders', 'Corrective Work Orders', 'Work Order Detail', 'Closure Evidence'], mappedExistingModule: 'UmmsMaintenance' },
      { id: 'preventive-maintenance', label: 'Preventive Maintenance', path: '/one/umms/workspace', status: 'implemented', l3: ['PM Risk Signal', 'Maintenance Plan Context', 'Schedule Action Workflow', 'PM Governance Audit', 'PM Evidence Pack', 'Maintenance Readiness Quality'], mappedExistingModule: 'UmmsMaintenance' },
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'export-center', label: 'Export & Evidence Center', path: '/reports', status: 'implemented', l3: ['PDF Export', 'Excel Export', 'Evidence Bundle', 'Customer Handoff Package', 'Scheduled Exports', 'Export History', 'Export Audit'], mappedExistingModule: 'ReportsView' },
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'protocol-gateway-operations', label: 'Protocol & Gateway Operations', path: '/uedge/diagnostics', status: 'mapped', l3: ['Protocol Risk Signal', 'Gateway Context Map', 'Connector Action Workflow', 'Protocol Governance Audit', 'Gateway Evidence Pack', 'Integration Readiness Quality'], mappedExistingModule: 'UedgeDiagnostics' },
      ...
      { id: 'industry-connectors', label: 'Industry Connectors', path: '/uedge/setup', status: 'mapped', l3: ['Industry Connector Risk', 'Industry System Context', 'Connector Enablement Actions', 'Connector Governance Audit', 'Connector Evidence Pack', 'Industry Readiness Quality'], mappedExistingModule: 'UedgeDiagnostics' },
