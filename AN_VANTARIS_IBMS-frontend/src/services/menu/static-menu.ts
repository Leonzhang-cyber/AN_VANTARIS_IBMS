...
const domains: MenuDomainInput[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'asset-registry', label: 'Asset Registry', path: '/one/assets/context', status: 'implemented', l3: ['Asset Risk Signal', 'Asset Relationship Context', 'Asset Action Workflow', 'Asset Governance Audit', 'Asset Evidence Pack', 'Asset Readiness Quality', 'Asset Lifecycle Profile', 'Asset Ownership', 'Asset Status History', 'Asset Maintenance History', 'Asset Warranty Status', 'Asset Documents', 'Asset Retirement / Replacement'], mappedExistingModule: 'AssetContext' },
      ...
      { id: 'points-tags', label: 'Point & Tag Governance', path: '/assets/topology', status: 'mapped', l3: ['Point Quality Signal', 'Tag Mapping Context', 'Point Action Workflow', 'Point Governance Audit', 'Point Evidence Pack', 'Tag Readiness Quality', 'Point Registry', 'Tag Binding Matrix', 'Point-to-Asset Binding', 'Point-to-System Binding', 'Telemetry Quality', 'Tag Naming Governance'], mappedExistingModule: 'AssetsTopology' },
      ...
      { id: 'floor-plan-hmi', label: 'Floor Plan / HMI Map', path: '/one/airport/assets-topology', status: 'mapped', l3: ['Floor Plan Risk Signal', 'Site Building Context', 'Zone Overlay Actions', 'Asset Alarm Relationship', 'Energy Overlay Evidence', 'HMI Map Readiness Audit', 'Floor Plan Equipment Location', 'HMI Equipment Locator', 'Zone-to-Asset Mapping', 'System-to-Asset Map', 'Point / Tag Overlay', 'Fault Location Overlay', 'Work Order Location Route', 'Technician Navigation Context'] },
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'inventory', label: 'Inventory', path: '/one/umms/workspace', status: 'mapped', l3: ['Stock Risk Signal', 'Spare Part Context', 'Material Request Actions', 'Critical Spare Governance', 'Inventory Evidence Pack', 'Supply Readiness Quality', 'Spare Parts Catalogue', 'Stock Level Monitor', 'Minimum Stock Alert', 'Reserved Parts', 'Parts-to-Asset Binding', 'Parts-to-Work-Order Binding', 'Reorder Request'], mappedExistingModule: 'UmmsMaintenance' },
      { id: 'vendors', label: 'Vendors', path: '/one/umms/workspace', status: 'mapped', l3: ['Vendor Risk Signal', 'Contract Coverage Context', 'Service Level Actions', 'Warranty Governance', 'Vendor Evidence Pack', 'Vendor Readiness Quality', 'Vendor Registry', 'Contract Scope', 'SLA Commitment', 'Warranty Coverage', 'Vendor Responsibility Matrix', 'Escalation Contact', 'Contract Expiry Risk', 'Vendor Work Orders'], mappedExistingModule: 'UmmsMaintenance' },
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'protocol-gateway-operations', label: 'Protocol & Gateway Operations', path: '/uedge/diagnostics', status: 'mapped', l3: ['Protocol Risk Signal', 'Gateway Context Map', 'Connector Action Workflow', 'Protocol Governance Audit', 'Gateway Evidence Pack', 'Integration Readiness Quality', 'Protocol Coverage Matrix', 'OPC UA Connector Health', 'SNMP Connector Health', 'Modbus Connector Health', 'BACnet Connector Health', 'OPC TCP/IP Gateway Status', 'Gateway Polling Status', 'Data Freshness', 'Protocol Evidence'], mappedExistingModule: 'UedgeDiagnostics' },
      ...
      { id: 'industry-connectors', label: 'Industry Connectors', path: '/uedge/setup', status: 'mapped', l3: ['Industry Connector Risk', 'Industry System Context', 'Connector Enablement Actions', 'Connector Governance Audit', 'Connector Evidence Pack', 'Industry Readiness Quality', 'ELV Source System Matrix', 'CCTV Integration', 'Access Control Integration', 'Public Address Integration', 'Radio Communication Integration', 'IPTV Integration', 'Clock System Integration', 'IPBX Integration', 'Toll / Parking Integration', 'Source System Evidence'], mappedExistingModule: 'UedgeDiagnostics' },
