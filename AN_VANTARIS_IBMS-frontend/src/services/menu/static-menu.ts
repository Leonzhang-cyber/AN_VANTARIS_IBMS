...
const domains: MenuDomainInput[] = [
  ...
  {
    id: 'data-asset-intelligence',
    label: 'Data & Asset Intelligence',
    path: '/one/assets/context',
    icon: 'D',
    children: [
      { id: 'asset-graph-intelligence', label: 'Asset Graph', path: '/one/assets/context', status: 'implemented', l3: ['Relationship Graph', 'Dependency View', 'Impact Path', 'Upstream / Downstream', 'System-to-Asset Mapping', 'Asset-to-Point Mapping', 'Fault Impact Graph', 'Maintenance Impact Graph', 'Evidence-linked Graph'], mappedExistingModule: 'AssetContext' },
  ...
  {
    id: 'udoc',
    label: 'UDOC - Unified Document Control',
    path: '/reports',
    icon: 'U',
    children: [
      ...
      { id: 'compliance-documents', label: 'Compliance Documents', path: '/reports', status: 'mapped', l3: ['IEC 62443 Documents', 'Green Mark Documents', 'ESG Documents', 'Customer Acceptance Documents', 'Audit Records', 'Submission Packages', 'Compliance Evidence'], mappedExistingModule: 'ReportsView' },
