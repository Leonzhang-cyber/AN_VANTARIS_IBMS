...
const domains: MenuDomainInput[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'space-mapping', label: 'Space Mapping', path: '/assets/topology', status: 'mapped', l3: ['Asset-to-Space Mapping', 'System-to-Space Mapping', 'Tag-to-Space Mapping', 'Floor Plan Binding', 'Mapping Gaps', 'Mapping Quality', 'Mapping Risk', 'Mapping Review', 'Mapping Evidence', 'Mapping Audit'], mappedExistingModule: 'AssetsTopology' },
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'preventive-maintenance', label: 'Preventive Maintenance', path: '/one/umms/workspace', status: 'implemented', l3: ['PM Calendar', 'PM Templates', 'PM Schedule', 'PM Checklist', 'PM Completion', 'Overdue PM Risk', 'PM Readiness', 'PM Review', 'PM Evidence', 'PM Reports', 'PM Audit'], mappedExistingModule: 'UmmsMaintenance' },
      ...
      { id: 'maintenance-analytics', label: 'Maintenance Analytics', path: '/one/umms/workspace', status: 'implemented', l3: ['MTTR', 'MTBF', 'Repeated Failures', 'Technician Load', 'Asset Reliability', 'Predictive Risk', 'Maintenance Impact', 'Improvement Actions', 'Analytics Evidence', 'Analytics Review'], mappedExistingModule: 'UmmsMaintenance' },
  ...
  },
  {
    ...
    icon: 'F',
    children: [
      { id: 'alarm-console', label: 'Alarm Console', path: '/one/airport/alarms-events', status: 'mapped', l3: ['Active Alarms', 'Critical Alarms', 'Acknowledgement', 'Shelving', 'Suppression', 'Escalation', 'Operator Notes', 'Alarm Impact', 'Alarm Risk', 'Alarm Evidence', 'Alarm Audit'] },
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'energy-faults', label: 'Energy Faults', path: '/uesg/sustainability', status: 'mapped', l3: ['High Consumption', 'Unoccupied Consumption', 'Weekend Consumption', 'Peak Demand', 'Meter Offline', 'Meter Flatline', 'Energy Fault Risk', 'Energy Fault Action', 'Energy Fault Evidence', 'Energy Fault Review'], mappedExistingModule: 'UesgSustainability' },
      { id: 'sustainability', label: 'Sustainability', path: '/uesg/sustainability', status: 'implemented', l3: ['Carbon Overview', 'ESG Metrics', 'Green Mark Support', 'Utility Baseline', 'Reduction Initiatives', 'Sustainability Risk', 'Sustainability Readiness', 'Sustainability Evidence', 'ESG Reports', 'ESG Audit'], mappedExistingModule: 'UesgSustainability' },
      ...
      { id: 'energy-compliance', label: 'Compliance', path: '/uesg/sustainability', status: 'mapped', l3: ['Energy Compliance', 'ESG Compliance', 'Compliance Gap', 'Compliance Risk', 'Audit Evidence', 'Report Export', 'Submission Package', 'Historical Records', 'Compliance Review', 'Compliance Audit'], mappedExistingModule: 'UesgSustainability' },
      { id: 'data-center-energy', label: 'Data Center Energy', path: '/uesg/sustainability', status: 'mapped', l3: ['UPS', 'PDU', 'Switchgear', 'Generator', 'Power Metering', 'Power Alarms', 'Power Trends', 'Power Chain Risk', 'PUE Evidence', 'Uptime Exposure', 'Power Readiness', 'Power Audit'], mappedExistingModule: 'UesgSustainability' },
    ],
  },
  {
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'document-library', label: 'Document Library', path: '/reports', status: 'mapped', l3: ['Document Register', 'Drawing Library', 'O&M Manuals', 'Method Statements', 'Test Reports', 'Vendor Documents', 'Revision History', 'Document Readiness', 'Document Evidence', 'Document Audit'], mappedExistingModule: 'ReportsView' },
      ...
      { id: 'asset-document-binding', label: 'Asset Document Binding', path: '/one/assets/context', status: 'mapped', l3: ['Asset-linked Documents', 'System-linked Documents', 'Equipment Manuals', 'Warranty Certificates', 'Spare Parts Documents', 'Maintenance Procedures', 'Binding Gaps', 'Binding Risk', 'Binding Review', 'Document-to-Asset Evidence', 'Binding Audit'], mappedExistingModule: 'AssetContext' },
      { id: 'handover-package-docs', label: 'Handover Package', path: '/reports', status: 'mapped', l3: ['Customer Handover Index', 'FAT / SAT Records', 'Commissioning Records', 'Training Records', 'Acceptance Checklist', 'Export Package', 'Handover Readiness', 'Open Handover Risks', 'Handover Evidence', 'Sign-off Audit'], mappedExistingModule: 'ReportsView' },
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'protocol-gateway-operations', label: 'Protocol & Gateway Operations', path: '/uedge/diagnostics', status: 'mapped', l3: ['BACnet Operations', 'Modbus Operations', 'OPC UA Operations', 'MQTT Operations', 'REST / Webhook Operations', 'SQL Read-only Source', 'File / Excel Import', 'SNMP / ONVIF Source', 'EDGE Gateway Mapping', 'LINK Gateway Mapping', 'Queue & Delivery', 'Offline Buffer', 'Gateway Diagnostics', 'Protocol Health', 'Gateway Risk', 'Gateway Readiness', 'Gateway Evidence', 'Gateway Audit'], mappedExistingModule: 'UedgeDiagnostics' },
      ...
      { id: 'industry-connectors', label: 'Industry Connectors', path: '/uedge/setup', status: 'mapped', l3: ['Building Systems', 'Shopping Mall Systems', 'Airport Systems', 'Data Center Systems', 'Oil & Gas Systems', 'Coking Plant Systems', 'Industrial Utility Systems', 'Multi-site Portfolio Systems', 'Connector Readiness', 'Connector Risk', 'Connector Review', 'Connector Evidence', 'Connector Audit'], mappedExistingModule: 'UedgeDiagnostics' },
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'engineering-operations', label: 'Engineering Operations', path: '/console/foundation-diagnostics/workspace', status: 'mapped', l3: ['Engineer Tools', 'Foundation Diagnostics', 'Offline Handoff', 'One-click Precheck', 'Engineer Inspection', 'Rollback Readiness', 'Engineering Risk', 'Diagnostics Evidence', 'Engineering Audit'], mappedExistingModule: 'FoundationDiagnosticsWorkspace' },
      ...
      { id: 'customer-portal-configuration', label: 'Customer Portal Configuration', path: '/system/settings', status: 'mapped', l3: ['Portal Branding', 'Customer Visibility', 'Portal Reports', 'Customer Evidence', 'Portal Access Policy', 'Portal Readiness', 'Portal Risk', 'Portal Review', 'Portal Audit'], mappedExistingModule: 'SystemSettingsView' },
      { id: 'feature-flags', label: 'Feature Flags', path: '/system/settings', status: 'implemented', l3: ['Feature Flags', 'Module Flags', 'Role Visibility', 'Package Flags', 'Flag Impact', 'Flag Risk', 'Flag Approval', 'Rollback Flag State', 'Flag Readiness', 'Flag Audit'], mappedExistingModule: 'SystemSettingsView' },
    ],
  },
]
