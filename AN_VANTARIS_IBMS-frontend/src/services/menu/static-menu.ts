...
const domains: MenuDomainInput[] = [
  ...
  },
  {
    ...
    icon: 'F',
    children: [
      { id: 'alarm-console', label: 'Alarm Console', path: '/one/airport/alarms-events', status: 'mapped', l3: ['Alarm Risk', 'Active Alarms', 'Operator Actions', 'Alarm Controls', 'Alarm Evidence Timeline', 'Alarm Readiness'] },
  ...
  },
  {
    ...
    icon: 'R',
    children: [
      { id: 'report-center', label: 'Report Center', path: '/reports', status: 'implemented', l3: ['Report Risk', 'Operations Reports', 'Report Actions', 'Report Review', 'Report Evidence', 'Report Readiness'], mappedExistingModule: 'ReportsView' },
