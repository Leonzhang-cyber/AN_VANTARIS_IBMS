#!/usr/bin/env python3
"""Generate the airport read-only frontend page contract artifact."""
...
OUTPUT = ROOT / "AN_VANTARIS_ONE/industry_profiles/airport/projections/airport-read-only-frontend-page-contract.v1.json"


def main() -> int:
    contract = build_airport_read_only_frontend_page_contract()
