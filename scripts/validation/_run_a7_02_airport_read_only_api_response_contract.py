#!/usr/bin/env python3
"""Generate the airport read-only API response contract artifact."""
...
OUTPUT = ROOT / "AN_VANTARIS_ONE/industry_profiles/airport/projections/airport-read-only-api-response-contract.v1.json"


def main() -> int:
    contract = build_airport_read_only_api_response_contract()
