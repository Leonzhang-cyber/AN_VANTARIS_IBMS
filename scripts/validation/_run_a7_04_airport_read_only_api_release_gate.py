#!/usr/bin/env python3
"""Generate the airport read-only API implementation release gate artifact."""
...
OUTPUT = ROOT / "AN_VANTARIS_ONE/industry_profiles/airport/projections/airport-read-only-api-implementation-release-gate.v1.json"


def main() -> int:
    gate = build_airport_read_only_api_release_gate()
