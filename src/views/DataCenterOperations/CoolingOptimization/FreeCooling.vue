    ...
    <template v-else>
      ...
      <div class="page-header">
        <div class="page-header-content">
          ...
          <el-tag type="danger" effect="dark" size="large">Airflow Management</el-tag>
        </div>
      </div>
...
const initAirflowChart = () => {
  if (airflowChartRef.value) {
    ...
    chart.setOption({
      ...
      series: [
        { type: 'bar', data: [12500, 11800, 13200, 5000, 11500, 12800], itemStyle: { borderRadius: [8, 8, 0, 0], color: '#409eff' }, label: { show: true, position: 'top', formatter: '{c} CFM' } }
      ]
    })
  ...
  if (fanWallChartRef.value) {
    ...
    chart.setOption({
      ...
      series: [{
        ...
        itemStyle: {
          borderRadius: [8, 8, 0, 0],
          color: (params: any) => fanSpeeds[params.dataIndex] > 0 ? '#409eff' : '#909399'
        },
