"""Deterministic model builders for A3 readiness release gates."""
...
def build_regression_matrix_entry(
    *,
    validator_name: str,
    command: str,
    expected_marker: str,
...
def build_boundary_matrix_entry(
    *,
    boundary_key: str,
    expected_value: Any,
    actual_value: Any,
...
def build_a3_readiness_release_gate(
    *,
    authority: str,
    profile_id: str,
    ...
    release_gate["deterministicDigest"] = sha256_digest(
        {key: value for key, value in release_gate.items() if key != "deterministicDigest"}
    )
    return release_gate
