"""Deterministic builders for the Airport read-only POC release gate."""
...
def build_release_decision(*, decision_state: str, release_candidate_allowed: bool, push_allowed: bool, tag_allowed: bool, production_activation_allowed: bool, runtime_activation_allowed: bool, database_write_allowed: bool, api_production_allowed: bool, frontend_production_allowed: bool, approval_execution_allowed: bool, decision_reason: str) -> dict[str, Any]:
    return _digest_item({
