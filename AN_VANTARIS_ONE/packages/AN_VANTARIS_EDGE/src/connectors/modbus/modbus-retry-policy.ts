import type { ModbusTcpReadOnlyPolicy, ModbusRetryBackoff, ModbusRetryDecision } from './modbus-readonly-types.js';

export function calculateModbusRetryBackoff(attempt: number, policy: ModbusTcpReadOnlyPolicy): ModbusRetryBackoff {
...
export function evaluateModbusRetryDecision(
