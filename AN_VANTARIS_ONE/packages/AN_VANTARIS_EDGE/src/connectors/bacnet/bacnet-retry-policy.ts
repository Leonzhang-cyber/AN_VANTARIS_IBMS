import type { BacnetIpReadOnlyPolicy, BacnetRetryBackoff, BacnetRetryDecision } from './bacnet-readonly-types.js';

export function calculateBacnetRetryBackoff(attempt: number, policy: BacnetIpReadOnlyPolicy): BacnetRetryBackoff {
...
export function evaluateBacnetRetryDecision(
