...
REPORTS_CATALOG: List[CatalogItem] = [
    ...
    },
    {
        ...
        "supportedFilters": ["timeRange", "siteId", "moduleId", "category", "severity", "aggregationLevel", "limit"],
    ...
    },
    {
        ...
        "supportedFilters": ["timeRange", "siteId", "assetId", "status", "category", "aggregationLevel", "limit"],
    ...
    },
    {
        ...
        "supportedFilters": ["timeRange", "siteId", "deviceId", "category", "status", "aggregationLevel", "limit"],
        "defaultFilters": {"timeRange": "last_30d"},
        "aggregationLevels": ["daily", "weekly", "monthly"],
        "exportFormats": ["view-only"],
        "evidenceLinked": True,
    ...
    },
    {
        ...
        "supportedFilters": ["timeRange", "moduleId", "evidenceReferenceId", "status", "aggregationLevel", "limit"],
        "defaultFilters": {"timeRange": "last_7d"},
    ...
    },
    {
        ...
        "supportedFilters": ["timeRange", "siteId", "moduleId", "status", "category", "aggregationLevel", "limit"],
        "defaultFilters": {"timeRange": "last_7d"},
    ...
    },
    {
        ...
        "supportedFilters": ["timeRange", "moduleId", "status", "category", "aggregationLevel", "limit"],
        "defaultFilters": {"timeRange": "last_24h"},
        "aggregationLevels": ["raw", "daily"],
        "exportFormats": ["view-only"],
        "evidenceLinked": False,
