...
def _package_record(
    *,
    ...
    platform: str = "VANTARIS ONE",
    industry_projection: str = "",
    description: str = "",
    ...
    edge_link_runtime_call: bool = False,
    customer_identifier_leakage: bool = False,
) -> Dict[str, Any]:
    return {
        ...
        "platform": platform,
        "industryProjection": industry_projection,
        "description": description,
        "productionActivation": bool(production_activation),
        "runtimeActivation": bool(runtime_activation),
        "dbWrite": bool(db_write),
        "approvalExecution": bool(approval_execution),
        "deploymentExecution": bool(deployment_execution),
        "edgeLinkRuntimeCall": bool(edge_link_runtime_call),
        "customerIdentifierLeakage": bool(customer_identifier_leakage),
...
def _base_packages() -> List[Dict[str, Any]]:
    ...
    return [
        _package_record(
            package_id="airport-ga-readonly",
            package_code="airport-ga-readonly",
            package_name="Airport GA Read-only",
            module_id="airport-ga-readonly",
            module_name="Airport Industry Solution",
            module_type="industry-solution",
            package_category="industry_solution",
            installed=True,
            entitled=True,
            enabled=True,
            visible=True,
            installed_version="2026.06-ga-readonly",
            available_version="2026.06-ga-readonly",
            patch_status="international-ga-ready-read-only",
            patch_mode="local-skeleton-patch",
            upgrade_required=False,
            activation_mode="read-only-projection-backed",
            locked_reason=None,
            customer_entry=_entry(
                enabled=True,
                visible=True,
                route="/one/airport/overview",
            ...
            role_visibility=_role_visibility(True, True, True),
            entry_status="active-read-only",
            limitations=[
                "Projection-backed read-only industry solution package.",
                "Runtime activation disabled.",
                "Production activation disabled.",
                "Deployment execution disabled.",
                "EDGE/LINK runtime calls disabled pending future shared foundation interfaces.",
            ],
            next_actions=[
                "Keep Airport as an industry solution projection.",
                "Define future EDGE/LINK shared foundation interface requirements outside GA-R4.",
            ],
            industry_projection="airport",
            description="Airport International GA-ready read-only industry solution package.",
            production_activation=False,
            runtime_activation=False,
            db_write=False,
            approval_execution=False,
            deployment_execution=False,
            edge_link_runtime_call=False,
            customer_identifier_leakage=False,
        ),
        _package_record(
        ...
        _package_record(
            ...
            installed_version="1.0.0",
            available_version="1.0.0",
            patch_status="placeholder-ready",
            patch_mode="local-skeleton-patch",
            upgrade_required=False,
            ...
            next_actions=["Keep UEDGE setup/diagnostics as placeholders until entitlement and runtime gates are approved."],
        ),
        _package_record(
            package_id="PKG-LINK",
