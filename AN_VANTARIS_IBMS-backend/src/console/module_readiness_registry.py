    ...
    return [
        ...
        _module_record(
            ...
            limitations=[
                ...
                "No EDGE or LINK integration is connected.",
        ...
        _module_record(
            ...
            runtime_status="foundation",
            readiness_level="r2-foundation",
            lifecycle_stage="esg-category-foundation",
            frontend_ready=True,
            backend_ready=True,
            api_ready=True,
            ...
            health_score=64,
            health_details={
                "frontend": _health_item("foundation", "Frontend", "UESG R2 category/calculation/trend views are available.", 65),
                "backend": _health_item("foundation", "Backend", "UESG category/calculation/quality/trend local skeleton is available.", 64),
                "api": _health_item("foundation", "API", "UESG R2 detail APIs are available.", 64),
                "audit": _health_item("planned", "Audit", "Formal ESG audit workflow is not integrated.", 40),
                "permission": _health_item("placeholder", "Permission", "Placeholder permission mode only.", 50),
                "dataPersistence": _health_item("foundation", "Data Persistence", "Local mock provider only.", 52),
                "security": _health_item("foundation", "Security", "Read-only foundation with no control actions.", 58),
                "integration": _health_item(
                    "local-skeleton",
                    "Integration",
                    "No meter/carbon-factor/EDGE/LINK integration in this stage.",
                    45,
                ),
            },
            limitations=[
                ...
                "No EDGE/LINK integration is connected.",
                "No certification reporting.",
                "No certified ESG calculations.",
                "No trend calculation.",
                "No data quality governance workflow.",
            ],
            dependencies=["local-uesg-provider", "uconsole"],
            next_actions=[
                "Add ESG persistence gate later.",
                "Add carbon factor governance later.",
                "Add meter ingestion safety gate later.",
                "Add ESG reporting readiness later.",
            ],
            readiness_notes=[
        ...
        _module_record(
            ...
            runtime_status="foundation",
            readiness_level="r1-foundation",
            lifecycle_stage="maintenance-runtime-foundation",
            frontend_ready=True,
            backend_ready=True,
            api_ready=True,
            audit_readiness="planned",
            ...
            health_score=58,
            health_details={
                "frontend": _health_item("foundation", "Frontend", "UMMS maintenance view is available.", 60),
                "backend": _health_item("foundation", "Backend", "UMMS local provider/service is available.", 58),
                "api": _health_item("foundation", "API", "UMMS foundation APIs are available.", 58),
                "audit": _health_item("planned", "Audit", "Audit readiness is planning-only in R1.", 38),
                "permission": _health_item("placeholder", "Permission", "Placeholder permission mode only.", 50),
                "dataPersistence": _health_item("foundation", "Data Persistence", "Local mock provider only.", 50),
                "security": _health_item("foundation", "Security", "Read-only foundation with no control actions.", 57),
                "integration": _health_item("local-skeleton", "Integration", "No dispatch/mobile/EDGE/LINK integration in this stage.", 46),
            },
            limitations=[
            ...
            dependencies=["local-umms-provider", "uconsole"],
            next_actions=[
                "Add persistent work order store later.",
                "Add dispatch workflow gate later.",
                "Add mobile integration gate later.",
                "Add Assets association runtime later.",
            ],
            readiness_notes=[
                "UMMS R1 establishes local skeleton maintenance runtime foundation.",
                "Work orders are local mock and read-only in this stage.",
                "Dispatch/mobile/notification integration is deferred.",
            ],
        ),
        _module_record(
            ...
            runtime_status="foundation",
            readiness_level="r2-foundation",
            lifecycle_stage="topology-relationship-foundation",
            frontend_ready=True,
            backend_ready=True,
            api_ready=True,
            audit_readiness="planned",
            ...
            health_score=63,
            health_details={
                "frontend": _health_item("foundation", "Frontend", "Assets topology relationship drilldown UI is available.", 66),
                "backend": _health_item("foundation", "Backend", "Assets hierarchy and relationship skeleton details are available.", 63),
                "api": _health_item("foundation", "API", "Assets relationship/lineage/impact skeleton APIs are available.", 63),
                "audit": _health_item("planned", "Audit", "Audit readiness planning only in R1.", 38),
                "permission": _health_item("limited", "Permission", "Placeholder permission mode only.", 48),
                "dataPersistence": _health_item("foundation", "Data Persistence", "Local mock provider only; no DB asset store.", 42),
                "security": _health_item("limited", "Security", "Read-only foundation with no signature integration.", 44),
                "integration": _health_item("limited", "Integration", "Runtime discovery and EDGE/LINK integration are not integrated.", 45),
            },
            limitations=[
                "No DB asset store.",
                "No runtime discovery.",
                "No EDGE or LINK integration is connected.",
                "No BIM or GIS integration.",
                "No real device status.",
                "No topology validation.",
                "Impact analysis is skeleton only.",
                "No telemetry correlation.",
            ],
            dependencies=["local-assets-provider", "router", "menu", "console-registry"],
            next_actions=[
                "Add persistent asset store later.",
                "Add topology validation later.",
                "Add EDGE/LINK asset ingestion later.",
            ],
            readiness_notes=[
