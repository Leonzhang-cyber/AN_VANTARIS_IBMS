...
def get_module_readiness_registry() -> List[Dict[str, Any]]:
    return [
        ...
        _module_record(
            ...
            lifecycle_stage="esg-runtime-foundation",
            frontend_ready=True,
            backend_ready=True,
            api_ready=True,
            ...
            health_score=58,
            health_details={
                "frontend": _health_item("foundation", "Frontend", "UESG sustainability view is available.", 60),
                "backend": _health_item("foundation", "Backend", "UESG local provider/service is available.", 60),
                "api": _health_item("foundation", "API", "UESG foundation APIs are available.", 60),
            ...
            next_actions=[
                "Add persistent ESG store later.",
                "Add meter ingestion later.",
                "Add carbon factor governance later.",
                "Add ESG report workflow later.",
            ],
            readiness_notes=[
                "UESG R1 establishes local skeleton ESG runtime foundation only.",
                "All ESG metrics are mock/read-only in this stage.",
