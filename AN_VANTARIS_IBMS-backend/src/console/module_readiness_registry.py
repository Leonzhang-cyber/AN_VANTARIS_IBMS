...
def get_module_readiness_registry() -> List[Dict[str, Any]]:
    return [
        ...
        _module_record(
            ...
            lifecycle_stage="asset-topology-foundation",
            frontend_ready=True,
            backend_ready=True,
            api_ready=True,
            audit_readiness="planned",
            ...
            health_score=58,
            health_details={
                "frontend": _health_item("foundation", "Frontend", "Assets and topology read-only UI is available.", 60),
                "backend": _health_item("foundation", "Backend", "Assets provider and service skeleton are available.", 58),
                "api": _health_item("foundation", "API", "Assets health/list/detail/summary/topology APIs are available.", 58),
                ...
                "integration": _health_item("limited", "Integration", "Runtime discovery and EDGE/LINK calls are not integrated.", 40),
            },
            limitations=[
                "No DB asset store.",
            ...
            readiness_notes=[
                "Assets R1 uses local skeleton topology and read-only asset catalog.",
