...
def _module_record(
    *,
    ...
    return {
        ...
        "domain": domain,
        "route": route or "",
        "engineerRoute": engineer_route or "",
...
def get_module_readiness_registry() -> List[Dict[str, Any]]:
    return [
        ...
        _module_record(
            ...
            domain="edge-setup-diagnostics",
            route="/uedge/setup",
            engineer_route="/uedge/diagnostics",
            runtime_status="foundation",
            readiness_level="r1-foundation",
            lifecycle_stage="edge-setup-diagnostics-foundation",
            frontend_ready=True,
            backend_ready=True,
            api_ready=True,
            audit_readiness="planned",
            ...
            health_score=54,
            health_details={
                "frontend": _health_item("foundation", "Frontend", "UEDGE setup and diagnostics placeholder pages are available.", 56),
                "backend": _health_item("foundation", "Backend", "UEDGE local provider/service skeleton is available.", 54),
                "api": _health_item("foundation", "API", "UEDGE setup/diagnostics read-only APIs are available.", 54),
                "audit": _health_item("planned", "Audit", "No dedicated UEDGE audit workflow in this stage.", 35),
                "permission": _health_item("placeholder", "Permission", "Placeholder permission mode only.", 48),
                "dataPersistence": _health_item("not-integrated", "Data Persistence", "No persistence store is used in R1.", 40),
                "security": _health_item("foundation", "Security", "Read-only placeholder with no control actions.", 58),
                "integration": _health_item("limited", "Integration", "No EDGE or LINK runtime integration is connected.", 42),
            },
            limitations=[
                "No EDGE runtime integration connection.",
                "No connector/protocol diagnostics.",
                "No certificate/token provisioning.",
                "No network configuration changes.",
                "No LINK runtime integration connection.",
            ],
            dependencies=["uconsole", "local-uedge-provider", "package-center"],
            next_actions=[
                "Keep UEDGE setup and diagnostics in read-only skeleton mode.",
                "Introduce runtime integration only after explicit boundary approval.",
            ],
            readiness_notes=[
                "UEDGE R1 establishes customer setup and engineer diagnostics skeleton pages only.",
                "All operational actions remain disabled in this stage.",
            ],
        ),
        _module_record(
